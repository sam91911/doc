...
\pf\\
\pftab{
	\rom{1}&$\sd{B \to A} \to \sd{\sd{\lnot\lnot B} \to \sd{B \to A}}$&\ref{logic:A1}\\
	\rom{2}&$\sd{\sd{\lnot\lnot B} \to \sd{B \to A}} \to \sd{\sd{\sd{\lnot\lnot B} \to B} \to \sd{\sd{\lnot\lnot B} \to A}}$&\ref{logic:A2}\\
	\rom{3}&$\sd{B \to A} \to \sd{\sd{\sd{\lnot\lnot B} \to B} \to \sd{\sd{\lnot\lnot B} \to A}}$&\rom{1}, \rom{2}, \ref{logic:D1}\\
	\rom{4}&$\sd{\lnot\lnot B} \to B$&\ref{logic:DNe}\\
	\rom{5}&$\sd{B \to A} \to \sd{\sd{\lnot\lnot B} \to A}$&\rom{3}, \rom{4}, \ref{logic:D2}\\
